...
module DefiningGenericClasses = 
    ...
    type StateTracker<'T>(initialElement: 'T) = // 'T - параметр типа для класса
        ...
        /// Сохранение состояний в массиве
...
module OptionTypes = 
    /// Опциональные значения - это любой тип значений, помеченных ключевым словом Some или None.
...
module UnitsOfMeasure = 
    ...
    printfn "%A = %A" d d'
    // let error = d + d'       // Ошибка компиляции: несоответствие единиц измерения
...
module DatabaseAccess = 
    ...
    // Для построения объекта ConnectionString можно использовать обозреватель сервера. 
